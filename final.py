...
def predict_Heart(age,sex,cp,trestbps,chol,fbs,restecg,thalach,exang,oldspeak,slope,ca,thal):    
...
def main():
    ...
    if st.button("Predict"):
        result=predict_Heart(age,sex,cp,trestbps,chol,fbs,restecg,thalach,exang,oldspeak,slope,ca,thal)
